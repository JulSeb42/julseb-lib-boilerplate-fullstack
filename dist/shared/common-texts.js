...
exports.COMMON_TEXTS = {
	...
	EMAIL_SIGNUP_BODY: (user, token) =>
		`Hello ${user.fullName},<br /><br />Thank you for creating your account on ${site_data_1.SITE_DATA.NAME}! <a href="${process.env.ORIGIN}/verify/${token}/${user._id}">Click here to verify your account.</a>.`,
	EMAIL_RESET_PASSWORD_TITLE: `Reset your password on ${site_data_1.SITE_DATA.NAME}`,
	EMAIL_RESET_PASSWORD_BODY: (user, token) =>
